        ...
        jwtService
            ...
            .catch((_errors) => {
                ...
                if (Array.isArray(_errors)) {
                    ...
                    // Do something else if _errors is not an array
                    console.log('_errors is not an array');
                    dispatch(showMessage("An error as occured"));
                    // You can replace this with any other logic you want to execute
                }
